								...
								<div class="col-3">
									<div class="col-12 row">
										<div class="col-6">
											...
											<button type="button" class="btn btn-secondary" onclick="editAddress($(this).prev().val());">Edit </button>
										</div>
										<div class="col-6">
											<input type="hidden" name="id" value="{{$address->id}}">
											<button type="button" onclick="if(confirm('Are you sure?')) deleteAddress($(this).prev().val());" class="btn btn-secondary">Delete</button>
										</div>
									</div>
									<br>
									<div class="col-12">
